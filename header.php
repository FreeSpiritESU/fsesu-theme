        ...
        <header id='header' role='banner'>
            ...
            <nav id='primary-navigation' role='navigation'>
                 ...
                 */ 
                 ?>  
                <div class='skip-link'>
                    <a class='assistive-text' href="#content" title="<?php esc_attr_e( 'Skip to main content', 'fsesu' ); ?>">
                        <?php _e( 'Skip to main content', 'fsesu' ); ?>  
                    </a>
                </div><!-- .skip-link -->
                <div class='skip-link'>
                    <a class='assistive-text' href="#secondary" title="<?php esc_attr_e( 'Skip to secondary content', 'fsesu' ); ?>">
